...
`
            ...
            currentMarkdown: '',
            fullMarkdown: `新年快乐！小袁老师
----

不知道你喜不喜欢这个称呼，先就这么叫了。
想不到加班就是在写这个吧，从小我语文就不好，憋半天也蹦不出几个字来。
比如写这段话，对我来说就太南了。如果写得不好，还望多包容包容哈~

先简单介绍一下，我从小对物理和计算机感兴趣，志愿全部填的计算机类。
...
如果说真正的爱好是追求真理，会不会显得太搞笑了，但我觉得只有对未知的探索才永远那么吸引人。
工作了才感觉数学实在是太有用了，尤其是一些思想和方法，可惜当时没有好好学。
只怪大学时太年轻啊，光喜欢去折腾一些有趣好耍的计算机技术，结果在码农的路上越走越远。
扯远了，说起来我爱好也有挺多，但某些可能是阶段性的（或者叫螺旋上升～），比如：
...
不知道你的性格是怎样的，希望都不要太紧张，反正都多认识了个朋友嘛。
写到现在已经感觉脑子里面一团乱麻，总之新年快乐啦
